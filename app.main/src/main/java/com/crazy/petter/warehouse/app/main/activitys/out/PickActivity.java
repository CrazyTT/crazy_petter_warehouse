...
//            return;
    ...
    private void jump(int postion) {
        mEdtOrderNum.setText(JsonUtil.getString(mOrderAdapter.getList().get(postion),""));
        mEdtOrderNum.setSelection(JsonUtil.getString(mOrderAdapter.getList().get(postion),"").length());
