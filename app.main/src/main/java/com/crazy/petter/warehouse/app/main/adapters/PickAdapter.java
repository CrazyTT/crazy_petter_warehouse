...
public class PickAdapter extends RecyclerView.Adapter<PickAdapter.ViewHolder> {
    public ArrayList<PickBean.DataEntity> datas = new ArrayList<>();
    private Context mContext;
    OrderTodoAdapterCallBack mOrderTodoAdapterCallBack;

    public PickAdapter(Context context, PickAdapter.OrderTodoAdapterCallBack orderTodoAdapterCallBack) {
    ...
    @Override
    public PickAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void setList(ArrayList<PickBean.DataEntity> mList) {
        datas = mList;
        notifyDataSetChanged();

    }

    public void addList(ArrayList<PickBean.DataEntity> mList) {
        datas.addAll(mList);
        notifyDataSetChanged();
    }

    public ArrayList<PickBean.DataEntity> getList() {
        return datas;
    }
    ...
    public void addItem(PickBean.DataEntity content, int postion) {
