...
public class CustomAlertController {
    ...
    private void setupContent(LinearLayout contentPanel) {
        ...
        if (mMessage != null) {
            ...
            if (mListView != null) {
                ...
                contentPanel.addView(mListView, new LinearLayout.LayoutParams(MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel, View customPanel, boolean hasButtons, TypedArray axxd, boolean hasTitle, View buttonPanel) {
        ...
        int fullDark = R.drawable.backgroud_custcom_alert;
        int topDark = R.drawable.backgroud_custcom_alert;
        int centerDark = R.drawable.backgroud_custcom_alert;
        int bottomDark = R.drawable.backgroud_custcom_alert;
        int fullBright = R.drawable.backgroud_custcom_alert;
        int topBright = R.drawable.backgroud_custcom_alert;
        int centerBright = R.drawable.backgroud_custcom_alert;
        int bottomBright = R.drawable.backgroud_custcom_alert;
        int bottomMedium = R.drawable.backgroud_custcom_alert;
    ...
    public static class AlertParams {
        ...
        private void createListView(final CustomAlertController dialog) {
            ...
            if (mIsMultiChoice) {
                ...
                int layout = mIsSingleChoice? R.layout.custom_select_dialog_singlechoice : R.layout.custom_select_dialog_item;
                if (mCursor == null) {
